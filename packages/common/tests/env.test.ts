...
describe('env helper', () => {
  ...
  it('reads numbers and api base url from process env', async () => {
    ...
    process.env.VITE_POSITIONS_PORT = '4002'
    ...
    expect(cfg.positionsPort).toBe(4002)
